...
ADD imports/bin/setup /usr/local/bin/setup/1525043835
ADD imports/bin/config /usr/local/bin/config/1525043835


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525043835 1>/dev/stdout 2>/dev/stderr
