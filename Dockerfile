...
ADD imports/bin/setup /usr/local/bin/setup/1524824423
ADD imports/bin/config /usr/local/bin/config/1524824423


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1524824423 1>/dev/stdout 2>/dev/stderr
