...
ADD imports/bin/setup /usr/local/bin/setup/1524592450
ADD imports/bin/config /usr/local/bin/config/1524592450


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1524592450 1>/dev/stdout 2>/dev/stderr
