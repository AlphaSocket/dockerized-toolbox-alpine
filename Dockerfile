...
ADD imports/bin/setup /usr/local/bin/setup/1525823051
ADD imports/bin/config /usr/local/bin/config/1525823051


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525823051 1>/dev/stdout 2>/dev/stderr
