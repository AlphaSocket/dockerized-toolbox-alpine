...
ADD imports/bin/setup /usr/local/bin/setup/1525129253
ADD imports/bin/config /usr/local/bin/config/1525129254


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525129253 1>/dev/stdout 2>/dev/stderr
