...
ADD imports/bin/setup /usr/local/bin/setup/1525823232
ADD imports/bin/config /usr/local/bin/config/1525823232


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525823232 1>/dev/stdout 2>/dev/stderr
