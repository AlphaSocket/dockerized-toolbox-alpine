...
ADD imports/bin/setup /usr/local/bin/setup/1526775486
ADD imports/bin/config /usr/local/bin/config/1526775486
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1526775486 1>/dev/stdout 2>/dev/stderr
