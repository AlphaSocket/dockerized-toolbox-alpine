...
ENV \
	...
	SETUP_DEPENDENCIES_BUILD="gcc python-dev" \
...
ADD imports/bin/setup /usr/local/bin/setup/1525135047
ADD imports/bin/config /usr/local/bin/config/1525135047


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525135047 1>/dev/stdout 2>/dev/stderr
