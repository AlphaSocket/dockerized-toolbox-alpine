...
ADD imports/bin/setup /usr/local/bin/setup/1526938771
ADD imports/bin/config /usr/local/bin/config/1526938771
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1526938771 1>/dev/stdout 2>/dev/stderr
