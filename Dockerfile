...
ENV \
	...
	SETUP_DEPENDENCIES_SETUP="gcc python-dev" \
...
ADD imports/bin/setup /usr/local/bin/setup/1525135122
ADD imports/bin/config /usr/local/bin/config/1525135122


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525135122 1>/dev/stdout 2>/dev/stderr
