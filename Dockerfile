...
ADD imports/bin/setup /usr/local/bin/setup/1525137357
ADD imports/bin/config /usr/local/bin/config/1525137357


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525137357 1>/dev/stdout 2>/dev/stderr
