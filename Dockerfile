...
ADD imports/bin/setup /usr/local/bin/setup/1526936915
ADD imports/bin/config /usr/local/bin/config/1526936915
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1526936915 1>/dev/stdout 2>/dev/stderr
