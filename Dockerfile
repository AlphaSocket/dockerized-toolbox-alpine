...
ADD imports/bin/setup /usr/local/bin/setup/1526938920
ADD imports/bin/config /usr/local/bin/config/1526938920
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1526938920 1>/dev/stdout 2>/dev/stderr
