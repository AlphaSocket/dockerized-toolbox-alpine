...
ADD imports/bin/setup /usr/local/bin/setup/1527033973
ADD imports/bin/config /usr/local/bin/config/1527033973
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1527033973 1>/dev/stdout 2>/dev/stderr
