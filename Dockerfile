...
ADD imports/bin/setup /usr/local/bin/setup/1527034339
ADD imports/bin/config /usr/local/bin/config/1527034339
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1527034339 1>/dev/stdout 2>/dev/stderr
