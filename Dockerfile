...
ADD imports/bin/setup /usr/local/bin/setup/1526943548
ADD imports/bin/config /usr/local/bin/config/1526943548
...
RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1526943548 1>/dev/stdout 2>/dev/stderr
