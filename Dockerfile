...
ADD imports/bin/setup /usr/local/bin/setup/1525135697
ADD imports/bin/config /usr/local/bin/config/1525135697


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525135697 1>/dev/stdout 2>/dev/stderr
