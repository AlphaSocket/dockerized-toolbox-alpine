...
ADD imports/bin/setup /usr/local/bin/setup/1524822842
ADD imports/bin/config /usr/local/bin/config/1524822842


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1524822842 1>/dev/stdout 2>/dev/stderr
