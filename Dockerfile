...
ADD imports/bin/setup /usr/local/bin/setup/1525139947
ADD imports/bin/config /usr/local/bin/config/1525139947


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525139947 1>/dev/stdout 2>/dev/stderr
