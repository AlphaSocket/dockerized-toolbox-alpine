...
ADD imports/bin/setup /usr/local/bin/setup/1525134615
ADD imports/bin/config /usr/local/bin/config/1525134615


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1525134615 1>/dev/stdout 2>/dev/stderr
